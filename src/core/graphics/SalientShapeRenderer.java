...
public class SalientShapeRenderer implements Disposable {
    ...
    public SalientShapeRenderer (Camera cam) {
        this(cam,5000);
    }

    public SalientShapeRenderer (Camera cam, int maxVertices) {
        this(cam,maxVertices, null);
    }

    public SalientShapeRenderer (Camera cam,int maxVertices, ShaderProgram defaultShader) {
        if (defaultShader == null) {
            renderer = new SalientImmediateModeRenderer(maxVertices, false, true, 0,cam);
        } else {
            renderer = new SalientImmediateModeRenderer(cam,maxVertices, false, true, 0, defaultShader);
        }
    ...
    /** Draws a point using {@link ShapeRenderer.ShapeType#Point}, {@link ShapeRenderer.ShapeType#Line} or {@link ShapeRenderer.ShapeType#Filled}. */
    ...
    /** Draws a line using {@link ShapeRenderer.ShapeType#Line} or {@link ShapeRenderer.ShapeType#Filled}. */
    ...
    /** Draws a line using {@link ShapeRenderer.ShapeType#Line} or {@link ShapeRenderer.ShapeType#Filled}. The line is drawn with two colors interpolated
    ...
    public void curve (float x1, float y1, float cx1, float cy1, float cx2, float cy2, float x2, float y2, int segments) {
        check(ShapeRenderer.ShapeType.Line, null, segments * 2 + 2);
    ...
    /** Draws a triangle in x/y plane using {@link ShapeRenderer.ShapeType#Line} or {@link ShapeRenderer.ShapeType#Filled}. */
    ...
    /** Draws a triangle in x/y plane with colored corners using {@link ShapeRenderer.ShapeType#Line} or {@link ShapeRenderer.ShapeType#Filled}. */
    ...
    /** Draws a rectangle in the x/y plane using {@link ShapeRenderer.ShapeType#Line} or {@link ShapeRenderer.ShapeType#Filled}. The x and y specify the lower
     * left corner.
    ...
    /** Draws a cube using {@link ShapeRenderer.ShapeType#Line} or {@link ShapeRenderer.ShapeType#Filled}. The x, y and z specify the bottom, left, front
    ...
    /** Draws two crossed lines using {@link ShapeRenderer.ShapeType#Line} or {@link ShapeRenderer.ShapeType#Filled}. */
    ...
    /** Draws an arc using {@link ShapeRenderer.ShapeType#Line} or {@link ShapeRenderer.ShapeType#Filled}. */
    public void arc (float x, float y, float radius, float start, float degrees, int segments) {
        ...
        if (shapeType == ShapeRenderer.ShapeType.Line) {
            ...
            check(ShapeRenderer.ShapeType.Line, ShapeRenderer.ShapeType.Filled, segments * 3 + 3);
    ...
    /**
     * Draws an arc in three dimensions using {@link ShapeRenderer.ShapeType#Line} or {@link ShapeRenderer.ShapeType#Filled}.
     * @param originX x coordinate of the center of the arc
     * @param originY y coordinate of the center of the arc
     * @param originZ z coordinate of the center of the arc
     * @param normal the vector perpendicular to the plane of the arc
     ...
     *
     */
    public void arc (float originX, float originY, float originZ, Vector3 normal, float radius, float start, float degrees,
                     int segments) {
        if (segments <= 0) throw new IllegalArgumentException("segments must be > 0.");
        float colorBits = color.toFloatBits();
        float theta = (2 * MathUtils.PI * (degrees / 360.0f)) / segments;
        ...
        if (shapeType == ShapeRenderer.ShapeType.Line) {
            ...
            renderer.color(colorBits);
            renderer.vertex(originX, originY, originZ);
            renderer.color(colorBits);
            renderer.vertex(originX + cx, originY + cy, originZ);
            for (int i = 0; i < segments; i++) {
                renderer.color(colorBits);
                renderer.vertex(originX + cx, originY + cy, originZ);
                temp = cx;
    ...
    /** Draws a circle using {@link ShapeRenderer.ShapeType#Line} or {@link ShapeRenderer.ShapeType#Filled}. */
    ...
    /* draws a circle in the xyz plane oriented in the direction of the vector */
    public void circle(float x, float y, float z, Vector3 direction ,float radius,int segments){
        ...
        if (shapeType == ShapeRenderer.ShapeType.Line) {
            ...
            for (int i = 0; i < segments; i++) {
                renderer.color(colorBits);
                renderer.vertex(x + cx*ux + cy*vx, y + cx*uy + cy*vy, z + cx*uz + cy*vz);
                float temp = cx;
                cx = cos * cx - sin * cy;
                cy = sin * temp + cos * cy;
                renderer.color(colorBits);
    ...
    public void circle(Vector3 center, Vector3 normal, float radius, int segments){
        tempVec1.set(normal).cpy();
        tempVec0.set(center).cpy();
        circle(tempVec0.x, tempVec0.y, tempVec0.z, tempVec1, radius, segments);
    }
    ...
    /** Draws an ellipse using {@link ShapeRenderer.ShapeType#Line} or {@link ShapeRenderer.ShapeType#Filled}. */
    public void ellipse (float x, float y, float width, float height, int segments) {
        if (segments <= 0) throw new IllegalArgumentException("segments must be > 0.");
        check(ShapeRenderer.ShapeType.Line, ShapeRenderer.ShapeType.Filled, segments * 3);
        float colorBits = color.toFloatBits();
        float angle = 2 * MathUtils.PI / segments;
    ...
    /** Draws a cone using {@link ShapeRenderer.ShapeType#Line} or {@link ShapeRenderer.ShapeType#Filled}. */
    public void cone (float x, float y, float z, float radius, float height, int segments) {
        if (segments <= 0) throw new IllegalArgumentException("segments must be > 0.");
        check(ShapeRenderer.ShapeType.Line, ShapeRenderer.ShapeType.Filled, segments * 4 + 2);
        float colorBits = color.toFloatBits();
        float angle = 2 * MathUtils.PI / segments;
        float cos = MathUtils.cos(angle);
        float sin = MathUtils.sin(angle);
    ...
    /** Draws a polygon in the x/y plane using {@link ShapeRenderer.ShapeType#Line}. The vertices must contain at least 3 points (6 floats
     * x,y). */
    public void polygon (float[] vertices, int offset, int count) {
        ...
        check(ShapeRenderer.ShapeType.Line, null, count);
        float colorBits = color.toFloatBits();
    ...
    /** Draws a polyline in the x/y plane using {@link ShapeRenderer.ShapeType#Line}. The vertices must contain at least 2 points (4 floats
     * x,y). */
    ...
    /** Draws a triangle in x/y/z planeusing {@link ShapeRenderer.ShapeType#Line} or {@link ShapeRenderer.ShapeType#Filled}. */
    ...
    /** Draws a triangle in x/y/z plane with colored corners using {@link ShapeRenderer.ShapeType#Line} or {@link ShapeRenderer.ShapeType#Filled}. */
